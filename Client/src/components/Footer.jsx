        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            ...
            <p className="text-gray-300 mb-4 max-w-md">
              A community-driven Q&A platform where developers help each other solve coding problems and share knowledge.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link to="/tags" className="text-gray-300 hover:text-white transition-colors">
                  Tags
                </Link>
              </li>
              <li>
